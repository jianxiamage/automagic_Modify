...
cmdStr=''
#-------------------------------
cmdEndStr="automagic-Test:create work env by virtualenvwrapper.End------------------------------------"
#----------------------------------------------------------------------------------
source ./shell-log.sh
logFile=$logFile
#echo $logFile
...
write_log "INFO" "automagic-Test:create work env by virtualenvwrapper.Begin---------------------------"
...
echo -------------------------------------------------
echo 'creating the virtual environment:env-automagic...'
echo -------------------------------------------------
mkvirtualenv env-automagic
